...
//     date: 'May 1, 2025',
//     description:
//       'Explore how traditional bead artistry has taken the global fashion world by storm with its vibrant colors and rich culture.',
//     link: '/blog/1',
//   },
//   {
//     id: 2,
...
//     date: 'April 15, 2025',
//     description:
//       'A curated list of must-have beaded accessories that elevate your wardrobe this year.',
//     link: '/blog/2',
//   },
//   {
//     id: 3,
...
//     date: 'March 30, 2025',
//     description:
//       'Get to know the talented hands crafting each piece in our boutique with love and precision.',
//     link: '/blog/3',
//   },
// ];
...
//           <div
//             key={post.id}
//             className="border border-yellow-200 bg-yellow-50 rounded-xl shadow hover:shadow-lg transition p-6"
//           >
//             <h3 className="text-xl font-semibold text-black mb-2">{post.title}</h3>
//             <div className="flex items-center text-sm text-yellow-700 mb-3">
//               <Calendar className="w-4 h-4 mr-2" /> {post.date}
//             </div>
//             <p className="text-gray-800 mb-4">{post.description}</p>
//             <a
//               href={post.link}
//               className="text-yellow-600 font-semibold hover:underline hover:text-yellow-700"
//             >
//               Read more →
//             </a>
//           </div>
